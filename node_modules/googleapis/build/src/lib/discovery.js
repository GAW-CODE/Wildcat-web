...
var transporter = new google_auth_library_1.DefaultTransporter();
...
Discovery.prototype.discoverAllAPIs = function (discoveryUrl, callback) {
    ...
    transporter.request({ url: discoveryUrl, headers: headers })
        .then(function (res) {
        var items = res.data.items;
        async.parallel(items.map(function (api) {
            return function (cb) {
                self.discoverAPI(api.discoveryRestUrl, function (e, newApi) {
                    if (e) {
                        return cb(e);
                    }
                    api.api = newApi;
        ...
        .catch(function (e) {
        return generator_utils_1.handleError(e, callback);
    });
};
/**
...
Discovery.prototype.discoverAPI = function (apiDiscoveryUrl, callback) {
    ...
    if (typeof apiDiscoveryUrl === 'string') {
        ...
        if (apiDiscoveryUrl && !parts.protocol) {
            ...
            try {
                return fs.readFile(apiDiscoveryUrl, { encoding: 'utf8' }, function (err, file) {
